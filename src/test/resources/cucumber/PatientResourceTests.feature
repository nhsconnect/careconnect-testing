...
Feature: Patient Tests (version 0.11) .N-4-1
    ...
    Scenario: 4.1.1 Search Test address-postalcode=LS
        Given FHIR STU3 Server
        When I Get Patient?address-postalcode=LS
        Then the method response code should be 200
        And have >=10 Patient's returned

    Scenario: 4.1.2 Search Test address-postalcode=LS15 8BD
        Given FHIR STU3 Server
    ...
    Scenario: 4.1.3 Search Test address-postalcode=B689QP
        Given FHIR STU3 Server
        When I Get Patient?address-postalcode=B689QP
        Then the method response code should be 200
        And have 0 Patient's returned

    Scenario: 4.1.4 Search Test birthdate=1935-09-20
         Given FHIR STU3 Server
    ...
    Scenario: 4.1.5 Search Test birthdate=1935-09-21
         Given FHIR STU3 Server
         When I Get Patient?birthdate=1935-09-21
         Then the method response code should be 200
         And have 0 Patient's returned

    Scenario: 4.1.6 Search Test birthdate=1935
         Given FHIR STU3 Server
         When I Get Patient?birthdate=1935
         Then the method response code should be 200
         And have 1 Patient's returned

     Scenario: 4.1.7 Search Test birthdate=1917-06
         Given FHIR STU3 Server
     ...
     Scenario: 4.1.7a Search Test - Invalid parameter birthdate=191
         Given FHIR STU3 Server
         When I Get Patient?birthdate=191
         Then the method response code should be 400


    Scenario: 4.1.8 Search Test birthdate=eq1918-05-20
         Given FHIR STU3 Server
    ...
    Scenario: 4.1.10 Search Test birthdate=le1919-07-13
         Given FHIR STU3 Server
         When I Get Patient?birthdate=le1919-07-13
         Then the method response code should be 200
         And have 6 Patient's returned
         And contains Ids
             | PatientId |
             | 1038 |
             | 1050 |
    ...
    Scenario: 4.1.11 Search Test birthdate=gt2015-05-11
         Given FHIR STU3 Server
    ...
    Scenario: 4.1.12 Search Test birthdate=ge2015-05-11
         Given FHIR STU3 Server
         When I Get Patient?birthdate=ge2015-05-11
         Then the method response code should be 200
         And have 5 Patient's returned
         And contains Ids
             | PatientId |
             | 1045 |
             | 1046 |
    ...
    Scenario: 4.1.13 Search Test birthdate=sa2015-05-11
         Given FHIR STU3 Server
         When I Get Patient?birthdate=sa2015-05-11
         Then the method response code should be 422


    Scenario: 4.1.14 Search Test birthdate=eb1919-07-13
         Given FHIR STU3 Server
         When I Get Patient?birthdate=eb1919-07-13
         Then the method response code should be 422


    Scenario: 4.1.15 Search Test email=Judy.Welch@again.co.uk
         Given FHIR STU3 Server
    ...
    Scenario: 4.1.16 Search Test email=Judy
         Given FHIR STU3 Server
    ...
    Scenario: 4.1.17 Search Test family=Munoz
         Given FHIR STU3 Server
    ...
    Scenario: 4.1.18 Search Test family=Wilson
             Given FHIR STU3 Server
   ...
   Scenario: 4.1.19 Search Test family=munoz
            Given FHIR STU3 Server
            When I Get Patient?family=munoz
            Then the method response code should be 200
            And have 2 Patient's returned
   ...
   Scenario: 4.1.21 Search Test family=Jessop
            Given FHIR STU3 Server
   ...
   Scenario: 4.1.22 Search Test family=Mo
            Given FHIR STU3 Server
   ...
   Scenario: 4.1.23 Search Test gender=MALE
           Given FHIR STU3 Server
           When I Get Patient?gender=MALE
           Then the method response code should be 200
           And have >=10 Patient's returned

   Scenario: 4.1.24 Search Test gender=FEMALE
          Given FHIR STU3 Server
          When I Get Patient?gender=FEMALE
          Then the method response code should be 200
          And have >=10 Patient's returned

   Scenario: 4.1.25 Search Test gender=OTHER
          Given FHIR STU3 Server
          When I Get Patient?gender=OTHER
          Then the method response code should be 200
          And have 9 Patient's returned

   Scenario: 4.1.26 Search Test gender=male
          Given FHIR STU3 Server
          When I Get Patient?gender=male
          Then the method response code should be 200
          And have >=10 Patient's returned

   Scenario: 4.1.27 Search Test given=Kendra
             Given FHIR STU3 Server
   ...
   Scenario: 4.1.28 Search Test given=John
            Given FHIR STU3 Server
            When I Get Patient?given=John
            Then the method response code should be 200
            And have 0 Patient's returned

   Scenario: 4.1.29 Search Test given=kendra
            Given FHIR STU3 Server
            When I Get Patient?given=kendra
            Then the method response code should be 200
            And have 2 Patient's returned
